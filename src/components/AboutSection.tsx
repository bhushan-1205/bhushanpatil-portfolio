...
const ABOUT_TEXT =
  "I turn complex problems into clean mobile experiences — building Android applications with Java and weaving AI into every layer of my work. From intelligent websites to generative content, I focus on technology that solves real problems and scales with purpose.";
const AboutSection = () => {
  return (
    <section
      id="about"
                      ...
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          ...
                          },
                          {
                            ...
                            items: ['React', 'Tailwind', 'Pandas', 'NumPy', 'Scikit-learn'],
                          },
                          {
                            label: 'Tools & Platforms',
                            items: ['Vercel', 'Git', 'GitHub', 'Canva', 'Excel'],
                          },
                          {
                            label: 'AI & GenAI',
