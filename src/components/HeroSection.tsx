        ...
        <FadeIn delay={0} y={-20} className="relative">
          <div className="flex items-center justify-between px-6 pt-6 md:px-10 md:pt-8">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Resume Button — solid white */}
              <a
                href="/Bhushan Patil.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 rounded-full bg-white px-4 py-2 sm:px-5 sm:py-2.5 text-[10px] sm:text-xs font-medium uppercase tracking-[0.2em] text-black transition hover:scale-[1.03] hover:bg-white/90"
              >
              ...
              {/* Email Me Button — ghost */}
              <a
                href="#contact"
                className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 sm:px-5 sm:py-2.5 text-[10px] sm:text-xs font-medium uppercase tracking-[0.2em] text-white backdrop-blur-md transition hover:scale-[1.03] hover:bg-white/20"
              >
                Email me
              </a>
          ...
          <div className="w-full max-w-7xl px-6 md:px-10">
            ...
            <FadeIn delay={0.85} y={20}>
              <p className="mt-5 text-[10px] font-medium uppercase tracking-[0.3em] text-white/75 sm:text-xs md:mt-7 md:text-sm">
                Full Stack Developer · SIH 25 Finalist · AI Learner
              </p>
            </FadeIn>
          ...
          <FadeIn delay={1.1} y={20}>
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white backdrop-blur-md transition hover:scale-110 hover:bg-white/20 sm:h-12 sm:w-12"
              >
                {muted ? (
