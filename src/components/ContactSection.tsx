...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'bhushanpatil6578@gmail.com',
    href: 'mailto:bhushanpatil6578@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    ...
    href: 'https://wa.me/918530462866',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: '@bhushan-patil',
    href: 'https://www.linkedin.com/in/bhushan-patil-1990b1296',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@bhushan-1205',
    href: 'https://github.com/bhushan-1205',
  },
];
