...
const SERVICES = [
  {
    ...
    description:
      'Building intuitive, high-performance Android applications with Java — from concept to Play Store deployment, focused on clean UX and real-world usability.',
  },
  {
    number: '02',
    title: 'Web Development',
    description:
      'Building responsive, modern websites and web apps with React and Next.js — pixel-perfect on every screen, fast, and built to scale.',
  },
  {
    number: '03',
  ...
  },
  {
    ...
    description:
      'Connecting hardware to software — building embedded systems, sensor networks, and real-time device dashboards that bridge the physical and digital world.',
  },
];
